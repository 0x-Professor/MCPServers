...
load_dotenv()
ETHERSCAN_API_KEY = os.getenv("ETHERSCAN_API_KEY", "your api key") # Default key for testing purposes
INFURA_PROJECT_ID = os.getenv("INFURA_PROJECT_ID", "your api key")  # Default key for testing purposes
SUPPORTED_CHAINS = {
